...
#define CAN_RECV_ENTRY(ID_, SIZE_, CIRCULAR_) \
  __attribute__((unused)) static uint8_t can1_recv_queue_storage_##ID_[SIZE_ * sizeof(can_rx_payload_t)];
...
#define CAN_RECV_ENTRY(ID_, SIZE_, CIRCULAR_) \
  __attribute__((unused)) static uint8_t can2_recv_queue_storage_##ID_[SIZE_ * sizeof(can_rx_payload_t)];
...
#define CAN_RECV_ENTRY(ID_, SIZE_, CIRCULAR_) \
  __attribute__((unused)) static uint8_t recv_queue_storage_##ID_[SIZE_ * sizeof(can_rx_payload_t)];
