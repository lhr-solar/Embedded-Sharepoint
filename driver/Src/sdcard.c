...
//     // 1. Wait for SD card to power on
//     vTaskDelay(pdMS_TO_TICKS(2000));

//     // 2. ONLY test the hardware connection
//     if (SD_Init(sd, pdMS_TO_TICKS(1000)) == SD_OK) {
        
//         // SUCCESS: Turn the LED SOLID ON forever. 
//         // This means SPI works, Clocks work, and the SD card is awake!
...
//         // FAILED: Blink extremely fast. 
//         // This means the wires are dead, or the SD card is rejecting the clock.
//         for(;;) {
//             HAL_GPIO_WritePin(LED_PORT, LED_PIN, GPIO_PIN_SET);
