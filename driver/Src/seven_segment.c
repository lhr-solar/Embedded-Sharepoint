...
/*
 * Default segment->GPIO map for this board (__weak). A bsp board file or the
 * project may override it with a strong definition of the same dimensions to
 * remap the wiring -- this keeps board-specific pin choices out of the driver.
 */
__weak const led_t seven_segment_led[NUMBER_SEVEN_SEGMENTS][NUMBER_SEGMENTS] = {{{GPIO_PIN_10, GPIOB}, {GPIO_PIN_1, GPIOB}, {GPIO_PIN_14, GPIOB}, {GPIO_PIN_2, GPIOB}, {GPIO_PIN_0, GPIOB}, {GPIO_PIN_5, GPIOC}, {GPIO_PIN_4, GPIOC}},
