...
/*
 * Segment -> GPIO map: seven_segment_led[display][segment] = {Pin, Port}.
 * The driver ships a __weak default (see seven_segment.c); a board/project may
 * provide a strong definition of the same dimensions to remap the wiring.
 */
extern const led_t seven_segment_led[NUMBER_SEVEN_SEGMENTS][NUMBER_SEGMENTS];
