...
The EMC2305 is a **5‑channel PWM fan controller** with optional **closed‑loop RPM control** using tachometer feedback. This driver provides:

* Thread‑safe, non‑blocking I2C access using **FreeRTOS queues and semaphores**
* Support for **multiple concurrent callers**
* Support for **open‑loop PWM control** and **closed‑loop RPM control**
* Fan status and RPM measurement utilities

The driver is designed for **STM32 HAL + FreeRTOS** and **will not function without an RTOS**.
...
### EMC2305 Hardware Connections

At minimum:

* **I2C SDA / SCL** connected to the MCU I2C bus with pullups
* **Power and ground** correctly supplied
* **Fan PWM pins** wired to fans
* **Fan tachometer pins** wired (required for RPM control)

---

### Fan Electrical Requirements

From the driver behavior:
