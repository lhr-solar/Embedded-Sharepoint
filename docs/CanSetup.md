...
* [Elcon Charger](https://github.com/lhr-solar/PS-ChargerInterfacePCB/blob/CAN_Firmware/Firmware/Drivers/Src/ElconCAN.c) — example that uses extended IDs (29-bit)