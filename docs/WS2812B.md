...
![WS2812B PWM Generation](assets/ws2812b_assets/ws2812b_tim4_pwm_generation.png)

Set the counter period to be 1000, the prescaler to be 0, and counter mode to be up.
![WS2812B Timer Configuration](assets/ws2812b_assets/ws2812b_tim4_configuration.png)
...
![WS2812B DMA Configuration](assets/ws2812b_assets/ws2812b_dma_configuration.png)
...
## Examples
An example test for the LSOM can be found in [here](https://github.com/lhr-solar/Embedded-Sharepoint/blob/main/test/tests/ws2812b_test.c)
