...
/*
 * PSOM L431 only (validated board): HSE 8 MHz -> 80 MHz; same tree as test/tests/can_test.c.
 * Overrides weak SystemClock_Config in stm32l4xx_hal_init.c for this image.
 */
void SystemClock_Config(void) {
